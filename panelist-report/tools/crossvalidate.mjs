...
const out={
  ...
  fit:[r.fit.fitted,r.fit.placed_by_text,r.fit.not_placed,
       r.fit.pct_fitted,r.fit.pct_placed_by_text,r.fit.pct_not_placed,
       r.fit.kb_size,r.fit.has_case_id,r.fit.columns,
       r.fit.text_columns,r.fit.none_columns,
       r.fit.fits,r.fit.reads,r.fit.reasons,r.fit.values,
       r.fit.rows.slice(0,40),r.fit.rows.slice(-10),
       r.fit.by_text.slice(0,20),r.fit.no_place.slice(0,20)],
  inf3:[r.inference.from_subject,r.inference.from_description,
        r.inference.from_text,r.inference.by_bucket],
